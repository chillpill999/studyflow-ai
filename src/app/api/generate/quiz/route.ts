...
Generate exactly 5 multiple-choice questions based on the provided material.
...
Each object in the array must match this schema:
{
  ...
  "explanation": "Why this answer is correct"
    ...
    try {
      ...
      console.error("Failed to parse JSON quiz:", e, data.choices[0].message.content);
